...
class ShippingOption implements \JsonSerializable
{
    ...
    public function update($db)
    {
        ...
        return $db->query(
            "
            UPDATE `" . DB_PREFIX . "omniva_int_m_option`
            SET 
    ...
    public function save($db)
    {
        ...
        return $db->query("
            INSERT INTO `" . DB_PREFIX . "omniva_int_m_option`
    ...
    public static function getShippingOptions($db, $with_countries = false, $country_code = null)
    {
        $result = $db->query("
            ...
            FROM `" . DB_PREFIX . "omniva_int_m_option`
    ...
    public static function deleteById($option_id, $db)
    {
        $db->query(
            "
            DELETE FROM `" . DB_PREFIX . "omniva_int_m_option` WHERE `id` = " . (int) $option_id
        );

        $db->query(
            "
            DELETE FROM `" . DB_PREFIX . "omniva_int_m_option_country` WHERE `option_id` = " . (int) $option_id
        );
    }
}
