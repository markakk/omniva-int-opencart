...
class ParcelDefault implements \JsonSerializable
{
    ...
    public static function getGlobalDefault($db)
    {
        ...
        $result = $db->query("
            ...
            FROM `" . DB_PREFIX . "omniva_int_m_parcel_default`
    ...
    {
        return $db->query("
            DELETE FROM `" . DB_PREFIX . "omniva_int_m_parcel_default` WHERE `category_id` = '" . (int) $category_id . "'
        ");
    }
    ...
    public function save()
    {
        ...
        return self::$db->query("
            INSERT INTO `" . DB_PREFIX . "omniva_int_m_parcel_default` 
